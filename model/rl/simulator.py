...
class Simulator(object):
    ...
    def __init__(self, data_file_path: str, num_vehicles: int, opt: str):
        """

        Args:
            data_file_path: file path of data
        ...
        # all orders
        self.all_orders = pd.read_csv(data_file_path)  # dataframe

        # all vehicles
        self.all_vehicles = vm.initialize_vehicles(num_vehicles, opt)  # dataframe
